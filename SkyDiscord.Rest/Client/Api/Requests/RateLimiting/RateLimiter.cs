...
namespace SkyDiscord.Rest
{
    internal sealed class RateLimiter
    {
        ...
        public async Task HandleRateLimitedAsync(RestRequest request, RateLimit rateLimit)
        {
            ...
            //       (also move to SkyDiscord's buckets)
            ...
            {
                request.SetException(new SkyDiscordHttpException((HttpStatusCode) 429, null, "Rate-limit hit. Throwing due to Options.ThrowOnRateLimits."));
