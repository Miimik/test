...
{
    /// <summary>
    ///     Represents a color used by SkyDiscord.
    /// </summary>
    public readonly partial struct Color : IEquatable<int>, IEquatable<Color>, IComparable<int>, IComparable<Color>
    {
        ...
        public int CompareTo(Color other) => RawValue.CompareTo(other.RawValue);

        public bool Equals(int other) => RawValue == other;

        public int CompareTo(int other) => RawValue.CompareTo(other);
        ...
        public static bool operator >(Color left, Color right) => left.RawValue > right.RawValue;
        ...
        public static implicit operator int(Color value) => value.RawValue;

        public static implicit operator Color((byte R, byte G, byte B) value) => new Color(value.R, value.G, value.B);

        public static implicit operator (byte R, byte G, byte B)(Color value) => (value.R, value.G, value.B);

        public static implicit operator Color(System.Drawing.Color value) => new Color(value.R, value.G, value.B);
